...
void saacproto_ACCharLoad_send( int fd,char* id,char* pas,char* charname,int lock,char* opt,int mesgid,char* ip )
{
...
void saacproto_ACCharDelete_send( int fd,char* id,char* passwd,char* charname,char* option,int mesgid, char* userip )
{
	...
	saacproto_strcatsafe( saacproto.work , saacproto_mkstr_int( mesgid ) ,saacproto.workbufsize );
	saacproto_strcatsafe( saacproto.work , saacproto_mkstr_string( userip ) ,saacproto.workbufsize );
	saacproto_Send( fd , saacproto.work );
}
...
void saacproto_ACDelFmPoint_send(int fd, int fmindex)
{
	saacproto_CreateHeader(saacproto.work, "ACDelFmPoint");
	saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmindex), saacproto.workbufsize);
	saacproto_Send(fd, saacproto.work);
}
...
*/
  ...
  if( strcmp(funcname, "EFFECT") == 0){
	...
	if( strcmp( funcname , "QuerySafePasswd" ) == 0 ){
		char* id;
		int res;
		int charaindex;
		id = saacproto_wrapStringAddr( saacproto_stringwrapper[1] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[2] ));
		res = saacproto_demkstr_int( saacproto.token_list[3] );
		charaindex = saacproto_demkstr_int( saacproto.token_list[4] );
		saacproto_QuerySafePasswd_recv(fd, id, res, charaindex); 
		return 0;
	}
	
	if( strcmp( funcname , "AddSafePasswd" ) == 0 ){
		char* id;
		int res;
		int charaindex;
		id = saacproto_wrapStringAddr( saacproto_stringwrapper[1] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[2] ));
		res = saacproto_demkstr_int( saacproto.token_list[3] );
		charaindex = saacproto_demkstr_int( saacproto.token_list[4] );
		saacproto_AddSafePasswd_recv(fd, id, res, charaindex); 
		return 0;
	}
	
	if( strcmp( funcname , "PointCardSucces" ) == 0 ){
		char* id;
		int res;
		int point;
		int charaindex;
		id = saacproto_wrapStringAddr( saacproto_stringwrapper[1] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[2] ));
		res = saacproto_demkstr_int( saacproto.token_list[3] );
		point = saacproto_demkstr_int( saacproto.token_list[4] );
		charaindex = saacproto_demkstr_int( saacproto.token_list[5] );
		saacproto_PointCardSucces_recv(fd, id, res, point, charaindex); 
		return 0;
	}
	
	if( strcmp( funcname , "PointCardErr" ) == 0 ){
		char* id;
		int res;
		int charaindex;
		id = saacproto_wrapStringAddr( saacproto_stringwrapper[1] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[2] ));
		res = saacproto_demkstr_int( saacproto.token_list[3] );
		charaindex = saacproto_demkstr_int( saacproto.token_list[4] );
		saacproto_PointCardErr_recv(fd, id, res, charaindex); 
		return 0;
	}
	
	if( strcmp( funcname , "LoginTime" ) == 0 ){
		char* id;
		char* res;
		int charaindex;
		id = saacproto_wrapStringAddr( saacproto_stringwrapper[1] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[2] ));
		res = saacproto_wrapStringAddr( saacproto_stringwrapper[2] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[3] ));
		charaindex = saacproto_demkstr_int( saacproto.token_list[4] );
		saacproto_LoginTime_recv(fd, id, res, charaindex); 
		return 0;
	}
	
#ifdef _ONLINE_SHOP
	if( strcmp( funcname , "ACShop" ) == 0 ){
		char* res;
		int charaindex,shopnum,vippoint,piece,pieces,shopflag;
		charaindex = saacproto_demkstr_int( saacproto.token_list[2] );
		shopnum = saacproto_demkstr_int( saacproto.token_list[3] );
		vippoint = saacproto_demkstr_int( saacproto.token_list[4] );
		piece = saacproto_demkstr_int( saacproto.token_list[5] );
		pieces = saacproto_demkstr_int( saacproto.token_list[6] );
		shopflag = saacproto_demkstr_int( saacproto.token_list[7] );
		res = saacproto_wrapStringAddr( saacproto_stringwrapper[7] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[8] ));
		saacproto_ACShop_recv(fd, charaindex, shopnum, vippoint, piece, pieces, shopflag, res); 
		return 0;
	}
	
	if( strcmp( funcname , "ACShopBuy" ) == 0 ){
		char* res;
		int charaindex,shopnum,vippoint,piece,pieces,shopflag,shopno,buynum;
		charaindex = saacproto_demkstr_int( saacproto.token_list[2] );
		shopnum = saacproto_demkstr_int( saacproto.token_list[3] );
		vippoint = saacproto_demkstr_int( saacproto.token_list[4] );
		piece = saacproto_demkstr_int( saacproto.token_list[5] );
		...
		shopflag = saacproto_demkstr_int( saacproto.token_list[7] );
		res = saacproto_wrapStringAddr( saacproto_stringwrapper[7] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[8] ));
		shopno = saacproto_demkstr_int( saacproto.token_list[9] );
		buynum = saacproto_demkstr_int( saacproto.token_list[10] );
		saacproto_ACShop_recv(fd, charaindex, shopnum, vippoint, piece, pieces, shopflag, res); 
		saacproto_ACShopBuy_recv(charaindex, shopflag, shopno, buynum); 
		return 0;
	}
#endif
	
#ifdef _QUESTION_ONLINE
	if( strcmp( funcname , "ACQuestion" ) == 0 ){
		char* res;
		res = saacproto_wrapStringAddr( saacproto_stringwrapper[1] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[2] ));
...
#ifdef _ALL_ITEM
	if( strcmp( funcname , "ACAllnum" ) == 0 ){
		int flag,allnum;
		flag = saacproto_demkstr_int( saacproto.token_list[2] );
		allnum = saacproto_demkstr_int( saacproto.token_list[3] );
		saacproto_ACAllnum_recv(flag,allnum); 
		return 0;
	}
#endif

	if( strcmp( funcname , "ACFmPkOnlineSn" ) == 0 ){
		//DebugMainFunction="saac1";
		int manorindex,flag;
		//DebugMainFunction="saac2";
		char* gsname;
		//DebugMainFunction="saac3";
		manorindex = saacproto_demkstr_int( saacproto.token_list[2] );
		//DebugMainFunction="saac4";
		...
		//DebugMainFunction="saac5";
		flag = saacproto_demkstr_int( saacproto.token_list[4] );
		//DebugMainFunction="saac6";
		saacproto_ACFmPkOnlineSn_recv(manorindex,gsname,flag); 
		//DebugMainFunction="saac7";
		return 0;
	}

	if( strcmp( funcname , "ACSystemAllTalk" ) == 0 ){
		char* systemalltalkbuf;
		systemalltalkbuf = saacproto_wrapStringAddr( saacproto_stringwrapper[1] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[2] ));
		saacproto_ACSystemAllTalk_recv(systemalltalkbuf); 
		return 0;
	}
	
	if( strcmp( funcname , "ACPlayerAllTalk" ) == 0 ){
		char* servername;
		char* playername;
		char* playeralltalkbuf;
		...
		playername = saacproto_wrapStringAddr( saacproto_stringwrapper[2] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[3] ));
		playeralltalkbuf = saacproto_wrapStringAddr( saacproto_stringwrapper[3] , saacproto.workbufsize , saacproto_demkstr_string( saacproto.token_list[4] ));
		saacproto_ACPlayerAllTalk_recv(servername,playername,playeralltalkbuf); 
		return 0;
	}
...
void saacproto_ACNewDelFM_send(int acfd, int index, int charfdid)
{
...
void saacproto_ACSystemAllTalk_send( int acfd, char *data)
{
	saacproto_CreateHeader( saacproto.work , "ACSystemAllTalk" );
	saacproto_strcatsafe( saacproto.work , saacproto_mkstr_string( data) ,saacproto.workbufsize );
	saacproto_Send( acfd , saacproto.work );
}

void saacproto_ACPlayerAllTalk_send( int acfd, char *servername,char *playname,char *data)
{
	saacproto_CreateHeader( saacproto.work , "ACPlayerAllTalk" );
	saacproto_strcatsafe( saacproto.work , saacproto_mkstr_string( servername) ,saacproto.workbufsize );
	saacproto_strcatsafe( saacproto.work , saacproto_mkstr_string( playname) ,saacproto.workbufsize );
	saacproto_strcatsafe( saacproto.work , saacproto_mkstr_string( data) ,saacproto.workbufsize );
	saacproto_Send( acfd , saacproto.work );
}
