...
#ifdef _PETITEM__AMOI_E
#define ITEM_NOT_LIMIT         0x00000000 //ÎÞÏÞÖÆ
#define ITEM_NOT_DROP          0x00000010 //²»¿ÉÈÓ
#define ITEM_NOT_STREETVANDOR  0x00000100 //²»¿É°Úµê
#define ITEM_NOT_TRADE         0x00001000 //²»¿É½»Ò×
#define ITEM_NOT_MAIL          0x00010000 //²»¿ÉÓÊ¼Ä
#endif
